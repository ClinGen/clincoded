...
RUN apt-get install curl wget python3.4-dev python-virtualenv software-properties-common apt-transport-https -qqy
RUN add-apt-repository ppa:webupd8team/java && \
    ...
    add-apt-repository "deb https://deb.nodesource.com/node_5.x trusty main" && \
...
VOLUME /code
RUN ln -s /code/docker-enterpoint.sh /usr/local/bin/
