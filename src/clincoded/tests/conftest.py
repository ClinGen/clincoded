...
_app_settings = {
    ...
    'multiauth.policies': 'google session remoteuser accesskey',
    'multiauth.groupfinder': 'clincoded.authorization.groupfinder',
    'multiauth.policy.google.use': 'clincoded.authentication.NamespacedAuthenticationPolicy',
    'multiauth.policy.google.base': 'clincoded.google.GoogleAuthenticationPolicy',
    'multiauth.policy.google.namespace': 'google',
    ...
    'google.verifier': 'browserid.LocalVerifier',
    'google.siteName': 'ClinGen Submission',
    'load_test_only': True,
    'testing': True,
