...
var CurationInterpretationCase = module.exports.CurationInterpretationCase = React.createClass({
    mixins: [RestMixin],
    ...
    render: function() {
        return (
            <div className="variant-interpretation case">
                <ul className="section-case-interpretation clearfix">
                    <li className="col-xs-12 gutter-exc">
                        <div>
                            <h4>Case Interpretation</h4>
                            <div>Case Data placeholder</div>
                        </div>
                    </li>
                </ul>
            </div>
