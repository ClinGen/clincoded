                                ...
                                {this.state.variantInfo[i] ?
                                    <div>
                                        <div className="row">
                                            ...
                                            <span className="col-sm-7 text-no-input"><a href={this.state.variantInfo[i].clinvarVariantId + this.state.variantInfo[i].clinvarVariantId}>{this.state.variantInfo[i].clinvarVariantId}</a></span>
                                        </div>
                                        <div className="row">
