                ...
                <ol>
                    <li>
                        <span className="label-note">
                            Search for the desired MONDO term using the <a href={external_url_map['Mondo']} target="_blank">OLS MONDO</a> Search [<a href="https://github.com/ClinGen/clincoded/wiki/MONDO-Search-Help" target="_blank">Help</a>].
                        </span>
                    </li>
                    <li>
                        <span className="label-note">
