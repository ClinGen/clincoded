                ...
                <body onClick={this.handleClick} onSubmit={this.handleSubmit} className={this.state.demoWarning ? "demo-background" : ""}>
                    ...
                    <div>
                        ...
                        {this.state.demoWarning ?
                            <Notice noticeType='demo' noticeMessage={<span><strong>Note:</strong> This is a demo version of the site. Data entered will not be saved upon release of updated versions to the interfaces (roughly once per month). Please contact us at <a href="mailto:clingen-helpdesk@lists.stanford.edu" style={{color: '#FFFFFF'}}>clingen-helpdesk@lists.stanford.edu <i className="icon icon-envelope"></i></a> with any questions</span>} />
                            : null}
