                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="project-info site-title">
                                ...
                                <p className="lead">All users may register for our demo version of the ClinGen interfaces or explore them without registering via the "Demo Login" button at <a href="https://curation-test.clinicalgenome.org" target="_blank" rel="noopener noreferrer">curation-test.clinicalgenome.org</a></p>
