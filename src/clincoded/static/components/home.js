                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="project-info site-title">
                                ...
                                <p className="lead">Any user may explore the demo version of the ClinGen interfaces without creating an account by clicking on the "Demo Login" button, found in the header at <a href="https://curation-test.clinicalgenome.org" target="_blank" rel="noopener noreferrer">curation-test.clinicalgenome.org</a>. This is a generic login so all users selecting this option will operate as the "same" curator under the display name "ClinGen Test Curator". If you wish to register to use the demo version under your own account, please email us at <a href="mailto:clingen-helpdesk@lists.stanford.edu">clingen-helpdesk@lists.stanford.edu <i className="icon icon-envelope"></i></a></p>
